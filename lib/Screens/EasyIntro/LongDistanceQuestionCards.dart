...
class _QuestionPageState extends State<QuestionPage> {
  ...
  List<Map<String, dynamic>> _questions = [
    ...
    {
      'property': 'isLongDistance',
      'title': 'Are you open to long-distance relationships?',
      'options': ['Yes', 'No'],
      'assetImageUrl': 'assets/world.png',
    },
    {
      'property': 'willingToRelocate',
      'title': 'Are you willing to relocate?',
      'options': ['Yes', 'No', 'Maybe'],
      'assetImageUrl': 'assets/plane.png',
    },
  ];
